...
const About = ({ aboutData }: aboutProps) => {
  ...
  return (
    ...
    >
      ...
      <motion.h1 className="text-center font-bold mb-8 relative text-2xl md:text-3xl lg:text-4xl xl:text-4xl font-bold text-gray-900 dark:text-gray-100 px-4">
          ...
          <motion.div className="flex-1">
            <motion.h2 className="text-3xl font-bold mb-3">
              ...
              <span className="text-gray-700 dark:text-gray-100">
                {" "}
                / {myBio.specialization || "Full Stack Developer"}
              </span>
            </motion.h2>
